...
def generate_launch_description() -> LaunchDescription:
    ...
    default_robot_configs: List[Dict[str, str]] = [
        {'namespace': 'tb1', 'name': 'tb4_1', 'x': '-1.0',  'y': '0.0',  'z': '0.20', 'R': '0.0', 'P': '0.0', 'Y': '0.0'},
        {'namespace': 'tb2', 'name': 'tb4_2', 'x': '-0.5',  'y': '0.0',  'z': '0.20', 'R': '0.0', 'P': '0.0', 'Y': '0.0'},
        {'namespace': 'tb3', 'name': 'tb4_3', 'x': '0.5',  'y': '0.0',  'z': '0.20', 'R': '0.0', 'P': '0.0', 'Y': '0.0'},
        {'namespace': 'tb4', 'name': 'tb4_4', 'x': '1.0',  'y': '0.0',  'z': '0.20', 'R': '0.0', 'P': '0.0', 'Y': '0.0'},
